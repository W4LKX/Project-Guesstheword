...
word_image_pairs = [
    ...
    {"word": "Grape", "image": "grape.gif", "hint": "A small round fruit that is purple or green and grows in bunches."},
    {"word": "Bicycle", "image": "bicycle.gif", "hint": "A bike that you ride by using your feet on pedals."},
    {"word": "Strawberry", "image": "strawberry.gif", "hint": "A red fruit with small seeds on the outside and a sweet taste."},
]
...
def finish_game():
    if 'username' in session:
        ...
        session['score'] = 7  # ปรับคะแนนเต็มที่คุณต้องการ
